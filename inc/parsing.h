...
/*
** --- get_next_line ---
** Раньше это был отдельный get_next_line.h; всё объединено сюда,
** чтобы не тащить второй заголовок и не дублировать декларации
** ft_strlen/ft_strjoin/ft_strchr, которые и так приходят из libft.h
** выше (стандартные функции libft, сигнатуры совпадают).
** ft_strndup и safe_free — не входят в стандартный libft, поэтому
** остаются объявленными здесь, как и раньше.
*/
# ifndef BUFFER_SIZE
